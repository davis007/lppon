        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <span>{{ __('プロンプト作成') }}</span>
                    <a href="{{ route('prompts.index') }}" class="btn btn-secondary btn-sm">{{ __('戻る') }}</a>
                </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input id="concept" type="text" class="form-control @error('concept') is-invalid @enderror" name="concept" value="{{ old('concept') }}" required>
                                    @error('concept')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea id="purpose" class="form-control @error('purpose') is-invalid @enderror" name="purpose" rows="4" required>{{ old('purpose') }}</textarea>
                                    @error('purpose')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input id="target" type="text" class="form-control @error('target') is-invalid @enderror" name="target" value="{{ old('target') }}" required>
                                    @error('target')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="form-group mt-3">
                                    ...
                                    <input id="cta_button_text" type="text" class="form-control @error('cta_button_text') is-invalid @enderror" name="cta_button_text" value="{{ old('cta_button_text') }}" required>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <textarea id="profile" class="form-control @error('profile') is-invalid @enderror" name="profile" rows="4" required>{{ old('profile') }}</textarea>
                                    @error('profile')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="color_scheme" class="form-control @error('color_scheme') is-invalid @enderror" name="color_scheme" required>
                                        ...
                                        @foreach ($colorSchemes as $value => $label)
                                            <option value="{{ $value }}" {{ old('color_scheme') == $value ? 'selected' : '' }}>{{ $label }}</option>
                                        @endforeach
                                    </select>
                                    @error('color_scheme')
                                        <span class="invalid-feedback" role="alert">
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="framework" class="form-control @error('framework') is-invalid @enderror" name="framework" required>
                                        ...
                                        @foreach ($frameworks as $value => $label)
                                            <option value="{{ $value }}" {{ old('framework') == $value ? 'selected' : '' }}>{{ $label }}</option>
                                        @endforeach
                                    </select>
                                    @error('framework')
                                        <span class="invalid-feedback" role="alert">
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="font" class="form-control @error('font') is-invalid @enderror" name="font" required>
                                        ...
                                        @foreach ($fonts as $value => $label)
                                            <option value="{{ $value }}" {{ old('font') == $value ? 'selected' : '' }}>{{ $label }}</option>
                                        @endforeach
                                    </select>
                                    @error('font')
                                        <span class="invalid-feedback" role="alert">
                                    ...
                                    <div class="mt-2">
                                        @foreach ($animations as $value => $label)
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="checkbox" name="animations[]" id="animation_{{ $value }}" value="{{ $value }}" {{ is_array(old('animations')) && in_array($value, old('animations')) ? 'checked' : '' }}>
